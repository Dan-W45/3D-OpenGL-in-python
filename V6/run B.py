...
class Cube:
    def __init__(self,x,y,z):
        self.vertices=[0+x,1+y,0+z, 1+x,1+y,0+z, 1+x,0+y,0+z,               #North
                       0+x,1+y,0+z, 0+x,0+y,0+z, 1+x,0+y,0+z,
                       
                       0+x,0+y,0+z, 0+x,1+y,0+z, 0+x,1+y,1+z,               #West
                       0+x,0+y,1+z, 0+x,0+y,0+z, 0+x,1+y,1+z,
                       
                       0+x,1+y,0+z, 1+x,1+y,0+z, 1+x,1+y,1+z,               #Top
                       0+x,1+y,0+z, 0+x,1+y,1+z, 1+x,1+y,1+z,
                       
                       0+x,1+y,1+z, 0+x,0+y,1+z, 1+x,0+y,1+z,               #South
                       0+x,1+y,1+z, 1+x,1+y,1+z, 1+x,0+y,1+z,
                       
                       1+x,1+y,1+z, 1+x,1+y,0+z, 1+x,0+y,0+z,               #East
                       1+x,1+y,1+z, 1+x,0+y,1+z, 1+x,0+y,0+z,
                       
                       1+x,0+y,1+z, 0+x,0+y,1+z, 0+x,0+y,0+z,               #Bottom
                       1+x,0+y,1+z, 1+x,0+y,0+z, 0+x,0+y,0+z]
...
##        self.colorslst=[0.34,0.23,0.05, 0.34,0.23,0.05, 0.34,0.23,0.05,         #North
##                        0.34,0.23,0.05, 0.34,0.23,0.05, 0.34,0.23,0.05,
##                        
##                        0.34,0.23,0.05, 0.34,0.23,0.05, 0.34,0.23,0.05,         #West
##                        0.34,0.23,0.05, 0.34,0.23,0.05, 0.34,0.23,0.05,
##                        
##                        0.21,0.41,0.18, 0.21,0.41,0.18, 0.21,0.41,0.18,         #Top
##                        0.21,0.41,0.18, 0.21,0.41,0.18, 0.21,0.41,0.18,
##                        
##                        0.34,0.23,0.05, 0.34,0.23,0.05, 0.34,0.23,0.05,         #South
##                        0.34,0.23,0.05, 0.34,0.23,0.05, 0.34,0.23,0.05,
##
##                        0.34,0.23,0.05, 0.34,0.23,0.05, 0.34,0.23,0.05,         #East
##                        0.34,0.23,0.05, 0.34,0.23,0.05, 0.34,0.23,0.05,
##                        
##                        0.34,0.23,0.05, 0.34,0.23,0.05, 0.34,0.23,0.05,         #Bottom
##                        0.34,0.23,0.05, 0.34,0.23,0.05, 0.34,0.23,0.05]
##
...
def loadTexture():
    ...
    texid = glGenTextures(1, GL_TEXTURE_COORD_ARRAY)
    glBindTexture(GL_TEXTURE_2D, texid)
