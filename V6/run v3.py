...
class Cube:
    def __init__(self,x,y,z):
        self.vertices=[0+x,1+y,0+z, 1,0, 1+x,1+y,0+z, 0,1, 1+x,0+y,0+z, 1,1,              #North
                       0+x,1+y,0+z, 1,0, 0+x,0+y,0+z, 0,1, 1+x,0+y,0+z, 1,1,
                       
                       0+x,0+y,0+z, 1,0, 0+x,1+y,0+z, 0,1, 0+x,1+y,1+z, 1,1,              #West
                       0+x,0+y,1+z, 1,0, 0+x,0+y,0+z, 0,1, 0+x,1+y,1+z, 1,1,
                       
                       0+x,1+y,0+z, 1,0, 1+x,1+y,0+z, 0,1, 1+x,1+y,1+z, 1,1,              #Top
                       0+x,1+y,0+z, 1,0, 0+x,1+y,1+z, 0,1, 1+x,1+y,1+z, 1,1,
                       
                       0+x,1+y,1+z, 1,0, 0+x,0+y,1+z, 0,1, 1+x,0+y,1+z, 1,1,              #South
                       0+x,1+y,1+z, 1,0, 1+x,1+y,1+z, 0,1, 1+x,0+y,1+z, 1,1,
                       
                       1+x,1+y,1+z, 1,0, 1+x,1+y,0+z, 0,1, 1+x,0+y,0+z, 1,1,              #East
                       1+x,1+y,1+z, 1,0, 1+x,0+y,1+z, 0,1, 1+x,0+y,0+z, 1,1,
                       
                       1+x,0+y,1+z, 1,0, 0+x,0+y,1+z, 0,1, 0+x,0+y,0+z, 1,1,              #Bottom
                       1+x,0+y,1+z, 1,0, 1+x,0+y,0+z, 0,1, 0+x,0+y,0+z, 1,1]
...
##    -0.5f,  0.5f, 0.0f,   1.0f, 1.0f, 0.0f,   0.0f, 1.0f    // top left
        ...
        float_size = sys.getsizeof(c_float)
        self.tex_coord_offset = c_void_p(3 * float_size)
