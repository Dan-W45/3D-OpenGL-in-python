...
class Cube:
    def __init__(self,x,y,z):
        self.vertices=[-0.5+x,0.5+y,-0.5+z, 0.5+x,0.5+y,-0.5+z, 0.5+x,-0.5+y,-0.5+z, -0.5+x,-0.5+y,-0.5+z,
                       -0.5+x,-0.5+y,-0.5+z, -0.5+x,-0.5+y,0.5+z, -0.5+x,0.5+y,0.5+z, -0.5+x,0.5+y,-0.5+z,
                       -0.5+x,0.5+y,-0.5+z, 0.5+x,0.5+y,-0.5+z, 0.5+x,0.5+y,0.5+z, -0.5+x,0.5+y,0.5+z,
                       -0.5+x,0.5+y,0.5+z, -0.5+x,-0.5+y,0.5+z, 0.5+x,-0.5+y,0.5+z, 0.5+x,0.5+y,0.5+z,
                       0.5+x,0.5+y,0.5+z, 0.5+x,0.5+y,-0.5+z, 0.5+x,-0.5+y,-0.5+z, 0.5+x,-0.5+y,0.5+z,
                       0.5+x,-0.5+y,0.5+z, -0.5+x,-0.5+y,0.5+z, -0.5+x,-0.5+y,-0.5+z, 0.5+x,-0.5+y,-0.5+z]
